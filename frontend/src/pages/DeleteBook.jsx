    ...
    <div className="min-h-screen bg-[var(--bg-app)] p-3 md:p-5">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-xl border border-[var(--line)] bg-[var(--panel-bg)] shadow-[var(--shadow-elev)]">
        ...
        {loading ? (
          ...
          <div className="max-w-7xl mx-auto border border-[var(--line)] bg-[var(--panel-bg)] p-6 flex items-center justify-center">
            <div className="bg-[var(--card-bg)] p-8 rounded-lg shadow-lg text-center border border-[var(--line)] w-full max-w-md">
              <h1 className="text-3xl font-bold text-[var(--danger)] mb-4">Delete Book</h1>
              <h3 className="text-lg mb-6 text-[var(--text-soft)]">Are you sure you want to delete this book?</h3>
              <div className="flex justify-center gap-4">
                <button
                  onClick={handleDelete}
                  className="bg-[var(--danger)] hover:bg-[var(--danger-hover)] text-[var(--text-inverse)] px-4 py-2 rounded-md"
                >
                  Delete
                </button>
                <BackButton />
